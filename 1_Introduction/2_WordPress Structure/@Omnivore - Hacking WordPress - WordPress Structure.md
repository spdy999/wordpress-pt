---
id: 6337618f-d71c-4d30-afd6-2536a49034c3
---

# Hacking WordPress - WordPress Structure
#Omnivore

[Read on Omnivore](https://omnivore.app/me/hacking-word-press-18c9c74560e)
[Read Original](https://academy.hackthebox.com/module/17/section/41)
...
```groovy
Avenger666@htb[/htb]$ tree -L 1 /var/www/html/wp-content
.
├── index.php
├── plugins
└── themes
...
```stylus
Avenger666@htb[/htb]$ tree -L 1 /var/www/html/wp-includes
.
├── <SNIP>
├── theme.php
├── update.php
